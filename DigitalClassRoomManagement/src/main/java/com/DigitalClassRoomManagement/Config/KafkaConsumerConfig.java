...
public class KafkaConsumerConfig {
    ...
    @Bean
    public ConsumerFactory<String, KafkaNotificationDto> notificationConsumerFactory() {

        JsonDeserializer<KafkaNotificationDto> deserializer =
                new JsonDeserializer<>(KafkaNotificationDto.class);
    ...
    // 🔥 This bean name MUST match @KafkaListener(containerFactory = "notificationKafkaListenerFactory")
